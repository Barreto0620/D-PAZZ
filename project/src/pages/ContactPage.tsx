...
// ✅ REMOVIDO: A importação do Layout que causava o erro foi removida.
import { ContactForm } from '../components/ContactForm';
import { useTheme } from '../contexts/ThemeContext';
import { Helmet } from 'react-helmet';

// O componente ContactInfoItem permanece o mesmo.
...
// O componente FaqItem permanece o mesmo.
...
export const ContactPage: React.FC = () => {
  ...
  return (
    // ✅ REMOVIDO: O <Layout> que envolvia a página foi removido.
    <>
      <Helmet>
      ...
      {/* Seção do Cabeçalho */}
      <div className="relative bg-neutral-800 py-24 sm:py-32">
        <img
      ...
      {/* Seção Principal: Contato e Formulário */}
      ...
      <div className="bg-white dark:bg-neutral-900">
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
            ...
            <div className="mt-12 space-y-4 max-w-3xl mx-auto">
                <FaqItem question="Os tênis são originais?">
                    Sim, todos os nossos produtos são 100% originais, importados diretamente dos fabricantes e distribuidores autorizados. Garantimos a autenticidade de cada par.
                </FaqItem>
                <FaqItem question="Qual o prazo de entrega?">
                    O prazo de entrega varia de acordo com sua localização, mas geralmente fica entre 7 e 15 dias úteis. Você receberá um código de rastreio para acompanhar seu pedido.
                </FaqItem>
                <FaqItem question="Posso parcelar minha compra?">
                    Sim! Aceitamos parcelamento em até 12x no cartão de crédito, com as melhores taxas do mercado.
                </FaqItem>
                <FaqItem question="Como funciona a política de troca e devolução?">
                    Você tem até 7 dias após o recebimento para solicitar a troca ou devolução do produto, desde que ele não tenha sido usado e esteja na embalagem original. Entre em contato conosco para iniciar o processo.
                </FaqItem>
            </div>
        </div>
      </div>
