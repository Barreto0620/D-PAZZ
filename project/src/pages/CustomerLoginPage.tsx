...
export const CustomerLoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const success = await login(credentials.email, credentials.password, false);
  ...
  return (
    <div className="min-h-screen bg-light dark:bg-dark flex items-center justify-center px-4">
      <Helmet>
        <title>Login - ImportShop</title>
        <meta name="description" content="Acesse sua conta na ImportShop." />
      </Helmet>
