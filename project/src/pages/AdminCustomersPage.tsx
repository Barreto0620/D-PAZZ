...
import { Search, Trash2, XCircle } from 'lucide-react'; // Adicionado XCircle para o modal
...
  const handleDeleteCustomer = async (userId: string) => {
    setShowDeleteConfirm(null); // Esconde a confirmação imediatamente após o clique em "Confirmar"
    try {
...
                </tr>
              </thead>
              <AnimatePresence> {/* Adicionado AnimatePresence aqui */}
...
                        <button
                          onClick={() => setShowDeleteConfirm(customer.id)} // Não há mais o comentário problemático aqui
            ...
            <div className="bg-white dark:bg-dark-light rounded-lg shadow-xl p-6 max-w-sm w-full mx-auto border border-gray-200 dark:border-gray-700">
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Você tem certeza que deseja excluir o cliente <span className="font-semibold">{showDeleteConfirm}</span>? Esta ação não pode ser desfeita.
                </p>
