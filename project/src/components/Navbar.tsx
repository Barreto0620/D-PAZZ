    ...
    <>
      <style jsx>{`
        @keyframes dpazz-glow {
          ...
          14.28% { 
            background: linear-gradient(135deg, #C9A96E, #CD853F);
            box-shadow: 0 0 12px rgba(201, 169, 110, 0.4);
          }
          28.57% { 
            background: linear-gradient(135deg, #CD853F, #DC8B7C);
            box-shadow: 0 0 12px rgba(205, 133, 63, 0.4);
          }
          42.85% { 
            background: linear-gradient(135deg, #DC8B7C, #B8566C);
            box-shadow: 0 0 12px rgba(220, 139, 124, 0.4);
          }
          57.14% { 
            background: linear-gradient(135deg, #B8566C, #8B7355);
            box-shadow: 0 0 12px rgba(184, 86, 108, 0.4);
          }
          71.42% { 
            background: linear-gradient(135deg, #8B7355, #6B8E5A);
            box-shadow: 0 0 12px rgba(139, 115, 85, 0.4);
          }
          85.71% { 
            background: linear-gradient(135deg, #6B8E5A, #A5B968);
            box-shadow: 0 0 12px rgba(107, 142, 90, 0.4);
          }
          100% { 
            background: linear-gradient(135deg, #A5B968, #D4AF37);
            box-shadow: 0 0 12px rgba(165, 185, 104, 0.4);
          }
        }

        .cart-badge-animated {
          animation: dpazz-glow 12s ease-in-out infinite;
