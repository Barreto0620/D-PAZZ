                            ...
                            <div className="relative search-container">
                                <form onSubmit={handleSearch} className="relative">
                                    <input
                                        type="text"
                                        placeholder="Buscar..."
                                        className="px-4 py-2 pl-10 pr-4 rounded-full bg-gray-50 dark:bg-dark-lighter text-dark dark:text-white w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-primary focus:bg-white dark:focus:bg-dark-lighter border border-gray-200 dark:border-gray-600 transition-all duration-300"
                                        value={searchQuery}
                                ...
                                <div className="relative search-container mb-4">
                                    <form onSubmit={handleSearch} className="relative">
                                        <input
                                            ...
                                            className="w-full px-4 py-3 pl-10 rounded-full bg-gray-50 dark:bg-dark text-dark dark:text-white focus:outline-none focus:ring-2 focus:ring-primary border border-gray-200 dark:border-gray-600"
                                            value={searchQuery}
                                            onChange={handleSearchInputChange}
                                        />
